...
%     with passive curve --------------------------------------------------
%     [Hilldiffk, FTk] = ForceEquilibrium_lMtildeState_optPassive(ak,lMtildek,...
%         vMtildek,lM_projectedk,DatStore(trial).LMTinterp(k,:)',...
%         MuscProperties.params(Misc.idx_allMuscleList{trial},:),...
%         MuscProperties.kT(Misc.idx_allMuscleList{trial},1),...
%         MuscProperties.shift(Misc.idx_allMuscleList{trial},1),...
%         MuscProperties.kpe(Misc.idx_allMuscleList{trial},1),... % kpe
%         MuscProperties.ksf(Misc.idx_allMuscleList{trial},1),... % ksf
%         MuscProperties.ke0(Misc.idx_allMuscleList{trial},1));   % ke0
    [Hilldiffk, FTk] = ForceEquilibrium_lMtildeState_optPassive(ak,lMtildek,...
        vMtildek,lM_projectedk,DatStore(trial).LMTinterp(k,:)',...
        MuscProperties.params(Misc.idx_allMuscleList{trial},:),...
        MuscProperties.kT(Misc.idx_allMuscleList{trial},1),...
...
% with passive curve ------------------------------------------------------
[Fpe,FMltilde,FMvtilde] = getForceLengthVelocityProperties_setPassiveParam(Results.lMtildeopt(trial).(saveName)',...
    Results.vMtilde(trial).(saveName)',MuscProperties.params(Misc.idx_allMuscleList{trial},5)',...
    MuscProperties.params(Misc.idx_allMuscleList{trial},6)',... % kpe input=varVal x muscle
    MuscProperties.params(Misc.idx_allMuscleList{trial},7)',... % ksf input=varVal x muscle
    MuscProperties.params(Misc.idx_allMuscleList{trial},8)');   % ke0 input=varVal x muscle
