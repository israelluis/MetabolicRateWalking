...
%         Get muscle-tendon forces and derive Hill-equilibrium with passive parameters
        [Hilldiffk,FTk] = ForceEquilibrium_lMtildeState_lMoFree_lTsFree_kTFree_optPassive(ak,lMtildek,...
            ...
            Misc.ke0(1,Misc.idx_allMuscleList{trial})');   % ke0
...
%     [Fpe,FMltilde,FMvtilde] = getForceLengthVelocityProperties(Results.lMtildeopt(trial).MTE',Results.vMtilde(trial).MTE',Misc.params(5,Misc.idx_allMuscleList{trial}));
    % vMtildeMax muscle property is not optimized
    [Fpe,FMltilde,FMvtilde] = getForceLengthVelocityProperties_setPassiveParam(Results.lMtildeopt(trial).MTE',Results.vMtilde(trial).MTE',Misc.params(5,Misc.idx_allMuscleList{trial}),...
    ...
    Misc.ke0(1,Misc.idx_allMuscleList{trial}));   % ke0 input=varVal x muscle
